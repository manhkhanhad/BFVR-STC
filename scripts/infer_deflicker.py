...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input_path", type=str, default="./test_input/2.mp4")
    ...
    ckpt_path = load_file_from_url(
        url="https://github.com/Dixin-Lab/BFVR-STC/releases/download/init/ckpt-defilcker.pth",
...
# CUDA_VISIBLE_DEVICES=0 python scripts/infer_deflicker.py --input_path input.mp4 --output_base .