...
def write_np_to_video(frame_list, save_path):
    ...
    out = cv2.VideoWriter(save_path, fourcc, 24.0, (256, 256))
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input_path", type=str, default="./test_input/1.mp4")
    ...
    #     url="https://github.com/Dixin-Lab/BFVR-STC/releases/download/init/ckpt-bfvr.pth",
